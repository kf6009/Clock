...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Time}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@x{ {\VARIABLES} min ,\, hr\@s{8.2}}%
\@y{\@s{0}%
 Declare hour and minute as our state variables
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ Hours\@s{8.81} \.{\defeq} 1 \.{\dotdot} 12}%
\@x{ Minutes \.{\defeq} 0 \.{\dotdot} 59}%
\@pvspace{8.0pt}%
\@x{ time \.{\defeq} {\langle} hr ,\, min {\rangle}\@s{13.03}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ TimeType \.{\defeq}}%
\@x{\@s{16.4} \.{\land} hr \.{\in} Hours}%
\@x{\@s{16.4} \.{\land} min \.{\in} Minutes}%
\@pvspace{8.0pt}%
\@x{ minuteTick \.{\defeq} min \.{'} \.{=} ( min \.{+} 1 ) \.{\%} 60}%
\@pvspace{8.0pt}%
\@x{ HourTick \.{\defeq} hr \.{'} \.{=} ( hr \.{\%} 12 ) \.{+} 1}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{{\CASE}} structure is just a multi-way if.
 Rather like those found in \ensuremath{C} and java
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{0}{7.5}{}%
 Each \mbox{'}case\mbox{'} starts with a predicate followed by an arrow
 \ensuremath{\.{\rightarrow}
 } The formula between the arrow and box \ensuremath{{\Box}} is evaluated and
 is the value of
 the case expression
\end{cpar}%
\end{lcom}%
\@x{ Tick \.{\defeq} {\CASE}}%
 \@x{\@s{39.38} min \.{=} 59 \.{\rightarrow} minuteTick \.{\land} HourTick
 {\Box}}%
 \@x{\@s{39.38} {\OTHER} \.{\rightarrow} minuteTick\@s{7.18} \.{\land}
 {\UNCHANGED} hr}%
\@pvspace{8.0pt}%
\@x{ Initial \.{\defeq}}%
\@y{\@s{0}%
 Pick some non-deterministic starting point
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} hr\@s{7.22} \.{\in} Hours}%
\@x{\@s{16.4} \.{\land} min \.{\in} Minutes}%
\@x{}\midbar\@xx{}%
\@x{ Clock \.{\defeq} Initial \.{\land} {\Box} [ Tick ]_{ time}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 15 20:30:02 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Feb} 15
 12:12:41 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\end{lcom}%
\end{document}
